...
<p></p>
 ...
 to Account<br> <br>
<input type = "text" placeholder = "Input Account Number" name = "incomingAcc" required>

<p></p>
Transfer Amount<br><br>
<input id="inputAmt" type = "number"  step="any" placeholder = "Input Transfer Amount" name = "transAmt" min = "0.01" max="MyVar"  required>
<p></p>
